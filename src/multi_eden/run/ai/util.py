...
This module provides backward-compatible access to AI model configuration
while using the new factory system under the hood.
"""
import logging
import os
...
def get_default_model() -> str:
    ...
    if not default_model:
        raise RuntimeError(
            "No default model configured. Please ensure config/models.yaml contains an 'ai_models.default' setting."
        )
